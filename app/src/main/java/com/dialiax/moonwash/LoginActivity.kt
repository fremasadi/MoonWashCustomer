...
import com.dialiax.moonwash.databinding.ActivityLoginBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loginbutton.setOnClickListener {
            ...
            if (email.isBlank() || password.isBlank()) {
                Toast.makeText(this, "Silakan isi semua detailnya 😒", Toast.LENGTH_SHORT).show()
            } else {
            ...
            if (task.isSuccessful) {
                ...
                auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        Toast.makeText(
                            this,
                            "Pengguna Dibuat & Login BerhasilPengguna Dibuat & Login Berhasil 😁",
                            Toast.LENGTH_SHORT
                        ).show()
                        saveUserData()
                        updateUi(user)
                        ...
                        Log.d("Account", "createUserAccount: Authentication Gagal", task.exception)
                    }
                }
            }
        }
