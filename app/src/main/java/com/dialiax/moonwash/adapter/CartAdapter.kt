...
import com.dialiax.moonwash.databinding.CartItemBinding
...
class CartAdapter(
    ...
    private var CartEstimasi: MutableList<String>
                ...
                if (uniqueKey != null) {
                    cartItemsReference.child(uniqueKey).removeValue()
                        .addOnSuccessListener {
                            ...
                            if (CartEstimasi.isNotEmpty()) CartEstimasi.removeAt(position)
